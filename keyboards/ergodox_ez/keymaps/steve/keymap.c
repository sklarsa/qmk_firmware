...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [BASE] = LAYOUT_ergodox(
      ...
      OSM(MOD_LSFT),     KC_Z,           KC_X,       KC_C,        KC_V,       KC_B,      KC_TRNS,
      ...
      KC_TRNS,    KC_N,       KC_M,       KC_COMMA,   KC_DOT,   RCTL_T(KC_SLASH),OSM(MOD_RSFT),
  ...
  [CHARNUM] = LAYOUT_ergodox(
    ...
    KC_TRNS,  KC_EQL,  KC_PLUS, KC_LPRN,   KC_RPRN,  KC_GRV,
